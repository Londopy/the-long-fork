...
| `STALL_DAYS` | variable | Days without a new link before the tip block, badge, STATUS.txt and site say CHAIN STALLED. Set to 7; `0` turns the alarm off, and unset also means 7. The README's "Branches" section mentions the 7 days. |
